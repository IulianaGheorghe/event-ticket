...
const DateTimeToggle = ({
  ...
  return (
    <>
      ...
      >
        <SwitchThumb className="data-[state=checked]:bg-gray-700 data-[state=unchecked]:bg-gray-200 pointer-events-none block size-4 rounded-full transition-transform data-[state=checked]:translate-x-6 data-[state=unchecked]:translate-x-1" />
      </Switch>
